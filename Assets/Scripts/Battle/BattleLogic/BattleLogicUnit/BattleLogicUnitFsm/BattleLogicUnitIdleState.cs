...
public class BattleLogicUnitIdleState : BaseFsm<BattleLogicUnitState>
{
    protected BattleLogicUnitFsmManager fsmManager;
    public BattleLogicUnitIdleState(BattleLogicUnitState state, BattleLogicUnitFsmManager fsmManager):base(state, fsmManager)
    {
