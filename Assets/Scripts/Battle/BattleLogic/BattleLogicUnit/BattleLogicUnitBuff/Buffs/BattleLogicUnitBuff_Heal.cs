...
public class BattleLogicUnitBuff_Heal : BattleLogicUnitBuffBase
{
    public BattleLogicUnitBuff_Heal(BattleLogicUnitBuffManager mgr, BuffData_SO data_SO) : base(mgr, data_SO)
    {
